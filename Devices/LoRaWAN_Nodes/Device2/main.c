...
static const uint8_t deveui[LORAMAC_DEVEUI_LEN] = { 0x00, 0x5F, 0x0C, 0xD3, 0x6F, 0x8D, 0x15, 0x21 };
static const uint8_t appeui[LORAMAC_APPEUI_LEN] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x02, 0xD4, 0xAC };
static const uint8_t appkey[LORAMAC_APPKEY_LEN] = { 0xF5, 0xBE, 0x0C, 0xBC, 0x0A, 0x3D, 0x27, 0x88, 0xBE, 0x96, 0xE1, 0x6C, 0x2E, 0x58, 0x85, 0x4A };
