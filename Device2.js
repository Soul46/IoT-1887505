...
const accessToken = "uRfmpBelH7ygRt7aT8fw";
// Create constants that will be passed to the broker
const minTemperature = -50, maxTemperature = 50, minHumidity = 0, maxHumidity = 100, minWindDirection = 0, maxWindDirection = 360, minWindIntensity = 0, maxWindIntensity = 100, minRainHeight = 0, maxRainHeight = 50, deviceID = 2;
